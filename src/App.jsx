  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-[#FDF5F5] relative overflow-x-hidden font-sans pb-24">
      ...
      <main className="relative z-10">
        {activeTab === 'discover' && <Discover profiles={filteredProfiles} onProfileClick={setSelectedProfile} onLike={handleLike} />}
        {activeTab === 'profile' && <ProfileSettings />}
        {(activeTab === 'matches' || activeTab === 'messages') && <div className="text-center p-10 text-[#4A0E0E]/60">یہ سیکشن جلد فعال ہو جائے گا</div>}
      </main>
