    ...
    <header className="bg-[#3D0A0A] pt-4 pb-8 px-4 rounded-b-[40px] shadow-2xl relative z-50" dir="rtl">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          className="bg-[#D4AF37] p-1.5 rounded-full shadow-lg active:scale-95 transition-all relative group"
        >
          <Bell size={20} fill="#4A0E0E" stroke="none" />
          {/* متحرک نوٹیفیکیشن ڈاٹ */}
          <span className="absolute top-1 right-0 w-3 h-3 bg-red-600 border-2 border-[#3D0A0A] rounded-full animate-pulse"></span>
        </button>
        ...
        <div 
          className="w-10 h-8 rounded-full border-2 border-[#D4AF37] overflow-hidden bg-white cursor-pointer active:scale-90 transition-transform shadow-lg"
      ...
      <div className="flex gap-1 items-center">
        ...
        <button
          onClick={toggleSidebar}
          className="bg-[#D4AF37] p-1 rounded-2xl shadow-lg active:scale-90 transition-all hover:bg-[#c4a132] text-[#4A0E0E]"
        >
          <Menu size={22} />
        </button>
      </div>
