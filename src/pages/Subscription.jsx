  ...
  return (
    ...
    <div className="min-h-screen bg-[#1a0007] text-white pb-32 font-sans selection:bg-[#D4AF37]" dir="rtl">
      ...
      <div className="relative z-10">
        ...
        <div className="mx-4 mt-6 relative group overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#FDFBF7] to-[#f3e5d8] p-6 shadow-2xl">
          ...
          <div className="flex items-center justify-between relative z-10">
            ...
            <div className="w-[35%] drop-shadow-2xl animate-pulse">
            ...
            <div className="bg-[#FDFBF7] rounded-[2.5rem] p-8 text-[#4A0E0E] shadow-2xl border-t-8 border-[#D4AF37] animate-in slide-in-from-bottom duration-500">
              ...
              <div className="grid grid-cols-3 gap-3 mb-8">
                ...
                {["easypaisa", "jazzcash", "card"].map(m => (
                  ...
                  <button key={m} onClick={() => setPaymentMethod(m)} className={`h-16 rounded-2xl border-2 flex flex-col items-center justify-center gap-1 transition-all active:scale-90 ${paymentMethod === m ? "border-[#4A0E0E] bg-[#4A0E0E] text-[#D4AF37] shadow-xl" : "border-gray-200"}`}>



                    {m === 'card' ? <CreditCard size={18}/> : <Smartphone size={18}/>}
      ...
      <BottomNav currentTab="SUBSCRIPTION" setPage={setPage} />
